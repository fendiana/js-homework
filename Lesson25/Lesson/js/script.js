...
// list.showList(); //- нічого невідбувається тому що в стрілкових функціях немає this
...
// userInfo.logInfo.call(Vano, "developer"); //- до call ми передаємо аргументи через кому, у потрібному порядку
...
// showUserInfo.logInfo.apply(Vano, ["developer", "Lviv"]); //- до apply ми передаємо аргументи через дужки [] як масив, у потрібному порядку
