...
//Операнд – це те, до чого застосовуються оператори (частіше операнди називають аргументами).
...
//Остача від ділення % (залишок від ділення на певну цифру)
...
// одне = це оператор присвоєння
// два == це вже порівняння
// три === це строге порівняння (якщо щось порівнювати то краще викор. його)
...
// console.log(5 === 6 && 6 > 3);
// console.log(6 + 3 >= 9 && 8 + 1 === 9); //- обидві умови мають бути правильні

//   -----or (||)------ //

// console.log(5 * 5 === 25 || 2 * 2 === 6); //- якщо жодна з умов не виконалась то буде false

//   -----not (!) ------ //

// console.log(!false); //- знак оклику перед будь-чим перетворює на НЄ
...
//--- одинарні  //- в круглих дужках () передаємо умову, а в фігурних {} яка дія має відбутись якщо умова відбулась
// if (5 * 5 === 25) {
//   console.log("1");
// } else {
//   console.log("2");
...
/// ------Тернарний оператор------///
//- той самий if/else тільки в скороченій версії (умова ? що буде якщо виконалась : що буде якщо ні)
...
//   console.log("no");
// }
//- якщо виконались два if то воно обере перше правильне, або загалом найперше яке виявиться правильне
...
// ----------------------------------//
// ----------------------------------//
//- використовувати якщо багато умов
